...
export const postAppointment = catchAsyncErrors(async (req, res, next) => {
  ...
  const appointment = await Appointment.create({ firstName, lastName, email, phone, aadhaar, dob, gender, appointment_date, department, doctor: { firstName: doctor_firstName, lastName: doctor_lastName, }, hasVisited, address, doctorId, patientId, });
  res.status(200).json({
    success: true,
    appointment,
